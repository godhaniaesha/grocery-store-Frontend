...
function Seasonal({ setIsProductDetailPage, setIsVegetablePage, setSelectedProductId}) {
            ...
            <div className="a_header_container">
                <div className="a_garden-fresh">
                    <div className="a_garden-fresh-header">
                        <h2 className="a_garden-fresh-title">Seasonal Selections</h2>
                        <p  className="a_view-all">
